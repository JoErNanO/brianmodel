...
"""
    brianmodel
    ~~~~~~~~~~~~~
    This package contains an adapter pattern implementation for the Equation objects used by the Brian simulator (http://briansimulator.org/).

    :copyright 2014 Francesco Giovannini, Neurosys - INRIA CR Nancy - Grand Est
    :licence GPLv3, see LICENCE for more details
"""

from brianmodel import BrianModel
import utilities
